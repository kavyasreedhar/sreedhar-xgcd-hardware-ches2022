...
group_path -weight 100 -priority 1 -name critical   -through gcd/*_csa_bezout_inter/*_odd_delta_update_*/u_*
group_path -weight 100 -priority 1 -name critical_x -through gcd/*_csa_bezout_inter/u_*

set_disable_timing jtag_wrapper/**
